...
<html>
	<head>
		...
		<title>Edit : RFID smart health card</title>
			...
			<div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
				...
				<form class="form-horizontal" action="user data edit tb.php?id=<?php echo $id?>" method="post">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="dob" type="text"  placeholder="" value="<?php echo $data['dob'];?>" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="weight" type="text"  placeholder="" value="<?php echo $data['weight'];?>" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="height" type="text"  placeholder="" value="<?php echo $data['height'];?>" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="bloodgroup" type="text"  placeholder="" value="<?php echo $data['bloodgroup'];?>" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="diseases" type="text"  placeholder="" value="<?php echo $data['diseases'];?>" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="hos" type="text"  placeholder="" value="<?php echo $data['hos'];?>" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="dr" type="text"  placeholder="" value="<?php echo $data['dr'];?>" required>
						</div>
					</div>
